...
public class CustomLocationRepositoryImpl implements CustomLocationRepository {
    ...
    //implementation details: we use the elasticsearchOperations object to fulfill the search operation,
    // this operation needs a query object which is built by the transferred position and distance information,
    // the return type of the search operation are search hits, then we can get all the stay ids from those hits.
    @Override
